...
export default {
  ...
  const promptText = [
    ...
    "- Use multiple angles to present the same information differently each time (e.g., describe leadership from collaboration angle one time, from problem-solving angle another).",
    ...
    "- Draw from the profile document's narrative style, tone, and context to create responses that feel human and dynamic.",
    "",
    "SOURCE MATERIAL:",
    "Below are key profile facts and the full profile document. Use them as your grounding material.",
    "Rephrase, recontextualize, and combine them to create fresh, varied answers.",
    "",
    "Profile facts (remix these into varied answers):",
    ...
    "",
    "Full profile document (use this for tone, context, and detailed narrative):",
    PROFILE_DOCUMENT,
    "",
    ...
    "- Only answer using information from the source facts above. If the user asks outside these facts, offer related portfolio topics instead.",
    "- Do not invent personal details, project names, dates, or tools not listed in sources.",
    "- If the profile contains the answer, provide it directly and confidently—never say information is 'unavailable' or 'not specified'.",
    "",
    `User query: ${query}`
  ].join("\n");
