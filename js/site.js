...
const inlinePriorityKb = [
  {
    ...
    followups: ["Contact details", "What tools does he use?", "What roles is he looking for?", "Show VR projects"]
  },
  {
    intent: "contact_info",
    ...
    followups: ["Who is Fatih?", "Where is he based?", "What roles is he looking for?", "What tools does he use?"]
  }
];
...
function getCategoryBrowseFollowups(catId) {
  ...
  if (catId === "ui-ux") {
    return ["What tools does he use?", "What roles is he looking for?", "Show VR projects", "Contact details"];
  }
  if (catId === "ai") {
